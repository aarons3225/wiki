---
title: Update-Plex-Script
description: A script to update Plex
published: true
date: 2024-06-17T07:18:29.222Z
tags: homelab, self-hosted, plex
editor: markdown
dateCreated: 2024-06-17T07:18:29.222Z
---
...
Create a directory or navigate to your scripts directory.

```shell
sudo mkdir scripts					# creates a scripts folder in /home/USER/scripts
## or ##
...
```shell
sudo nano update-plex.sh
```

- Enter these contents[^1]:
```shell
#!/bin/bash
...
Then exit the file with CTRL + X, 'y', then hit enter.

## Running script

You should be able to run it with this command:
...
## Citation
[^1]: TOMSSL: [https://tomssl.com/update-plex-server-on-ubuntu-automatically/](https://tomssl.com/update-plex-server-on-ubuntu-automatically/)
